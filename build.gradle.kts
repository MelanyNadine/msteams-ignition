...
ignitionModule {
     ...
     */
    hooks.putAll(mapOf(
        "com.inductiveautomation.ignition.msteams.gateway.MsteamsGatewayHook" to "G",
        "com.inductiveautomation.ignition.msteams.client.MsteamsClientHook" to "C",
        "com.inductiveautomation.ignition.msteams.designer.MsteamsDesignerHook" to "D"
    ))
