 ...
 */
public class MsteamsGatewayHook extends AbstractGatewayModuleHook {
    /**
    ...
    private final GatewayMsteamsModule GatewayScriptModule = new GatewayMsteamsModule();
